        ...
        <div style="position: relative; top:70px; right:-160px ; width:300px; height:260px"> --}}
            <div class="container">
                <div class="row"><div class="text-right">
                    <a href="{{url('foodmenu')}}" class="btn btn-primary mt-3">Category Index</a>
                    </div>
                    <table class="table table-hover mt-4">
                        ...
                        @foreach ($data as $data)
                           <tr>
                            ...
                            <td> <img src="foodimage/{{ $data->image }}" class="rounded-circle"
                              width="35" height="35"/>
                            </td>
                            <td>
                              <a href="{{url('/updateview',$data->id)}}" class="btn btn-primary btn-sm">
                              Edit</a>
              
                              <a href="{{url('/deletemenu',$data->id)}}" class="btn btn-danger btn-sm">
                              Delete</a> 
