    ...
    <div class="row">
        ...
        <div class="card mb-4" style="--cui-card-cap-bg: #3b5998">
          <div class="card-header position-relative d-flex justify-content-center align-items-center">
            <svg class="icon icon-3xl text-white my-4">
              <use xlink:href="{{asset('icons/brand.svg#cib-facebook-f')}}"></use>
            </svg>
      ...
      <div class="col-sm-6 col-lg-4">
        <div class="card mb-4" style="--cui-card-cap-bg: #4875b4">
          <div class="card-header position-relative d-flex justify-content-center align-items-center">
            <svg class="icon icon-3xl text-white my-4">
              <use xlink:href="{{asset('icons/brand.svg#cib-linkedin')}}"></use>
            </svg>
            <div class="chart-wrapper position-absolute top-0 start-0 w-100 h-100">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-sm-6">
                <div class="row">
                  <div class="col-6">
                    <div class="border-start border-start-4 border-start-info px-3 mb-3"><small class="text-medium-emphasis text-truncate">New Clients</small>
                      <div class="fs-5 fw-semibold">9.123</div>
                    </div>
                  </div>
                  <!-- /.col-->
                  <div class="col-6">
                    <div class="border-start border-start-4 border-start-danger px-3 mb-3"><small class="text-medium-emphasis text-truncate">Recuring Clients</small>
              ...
              <div class="col-sm-6">
                <div class="row">
                  <div class="col-6">
                    <div class="border-start border-start-4 border-start-warning px-3 mb-3"><small class="text-medium-emphasis text-truncate">Pageviews</small>
                      <div class="fs-5 fw-semibold">78.623</div>
                    </div>
                  </div>
                  <!-- /.col-->
                  <div class="col-6">
                    <div class="border-start border-start-4 border-start-success px-3 mb-3"><small class="text-medium-emphasis text-truncate">Organic</small>
                ...
                <div class="progress-group mb-5">
                  <div class="progress-group-header">
                    <svg class="icon icon-lg me-2">
                      <use xlink:href="{{asset('icons/coreui.svg#cil-user-female')}}"></use>
                    </svg>
                    <div>Female</div>
                ...
                <div class="progress-group">
                  <div class="progress-group-header">
                    <svg class="icon icon-lg me-2">
                      <use xlink:href="{{asset('icons/brand.svg#cib-google')}}"></use>
                    </svg>
                ...
                <tbody>
                  <tr class="align-middle">
                    ...
                    <td>
                      ...
                      <div class="small text-medium-emphasis text-nowrap">New | Registered: Jan 1, 2020</div>
                    </td>
                    <td class="text-center">
                    ...
                    <td>
                      <div class="d-flex justify-content-between">
                        ...
                        <div class="float-end ms-1 text-nowrap"><small class="text-medium-emphasis">Jun 11, 2020 - Jul 10, 2020</small></div>
                      </div>
                      <div class="progress progress-thin">
                  ...
                  <tr class="align-middle">
                    ...
                    <td>
                      ...
                      <div class="small text-medium-emphasis text-nowrap">Recurring | Registered: Jan 1, 2020</div>
                    </td>
                    <td class="text-center">
                      <svg class="icon icon-xl">
                  ...
                  <tr class="align-middle">
                    ...
                    <td class="text-center">
                      <svg class="icon icon-xl">
                        <use xlink:href="{{asset('icons/brand.svg#cib-cc-paypal')}}"></use>
                      </svg>
                    </td>
                    <td>
                      <div class="small text-medium-emphasis">Last login</div>
                  ...
                  <tr class="align-middle">
                    ...
                    <td class="text-center">
                      <svg class="icon icon-xl">
                        <use xlink:href="{{asset('icons/brand.svg#cib-cc-apple-pay')}}"></use>
                      </svg>
                    </td>
                    <td>
                      <div class="small text-medium-emphasis">Last login</div>
