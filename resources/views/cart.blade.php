                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <div class="list-group">
                            ...
                            <span class="list-group-item list-group-item-action display-6 fw-bold text-success"
                                style="font-size: 24px !important;">Net Payable:
                                <span class="float-end">₹{{ $total_payable_amount = $net_payable + $delivery_charge }}
                                    @php
